...
export default function CursorEffect() {
    ...
    useEffect(() => {
        ...
        gsap.set(cursor, {opacity: 0, scale: 128, width: 32, height: 32, xPercent: -50, yPercent: -50});
        ...
        const onFirstMove = (e: MouseEvent) => {
            ...
            tl.to(cursor, {opacity: 1, scale: 1, duration: 0.6, ease: 'power3.out'}).play();
    ...
    return (
        <div
            ref={cursorRef}
            className="fixed top-0 left-0 z-[9999] border-2 border-black rounded-full pointer-events-none"
        />
    );
}
